...
3）中国大陆地区Ping GlobalSSH 的域名，如果可以 Ping 通，试试"telnet GlobalSSH域名 端口"是否可以连接（仍是无法连接请联系[UCloud售后咨询](https://spt.ucloud.cn/)）；如果 Ping 不通，请dig下 GlobalSSH域名，在[UCloud售后咨询](https://spt.ucloud.cn/)提交结果给UCloud工程师处理。  
